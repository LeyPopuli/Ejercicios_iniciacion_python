...
donde cada línea contiene la información del nombre, email, teléfono, nif, y el descuento que se le aplica. Las
 líneas se separan con el carácter de cambio de línea \n y la primera línea contiene los nombres de los campos 
...
6547F;Carmen Sánchez;carmen@mail.com;667677855;15.7"
...
del cliente. Los diccionarios con la información de cada cliente tendrán como claves los nombres de los campos y
 como valores la información de cada cliente correspondientes a los campos. Es decir, un diccionario como el 
 siguiente
...
directorio_bruto = "nif;nombre;email;teléfono;descuento\n01234567L;Luis González;luisgonzalez@mail.com;656343576;12.5\n71476342J;Macarena Ramírez;macarena@mail.com;692839321;8\n63823376M;Juan José Martínez;juanjo@mail.com;664888233;5.2\n98376547F;Carmen Sánchez;carmen@mail.com;667677855;15.7"

directorio_clean = directorio_bruto.split("\n")

campos_info = directorio_clean[0].split(";")

for item in directorio_clean[1:]:
    cliente = {}
    info_cliente = item.split(";")  

    for i in range(1, len(campos_info)):
        if campos_info[i] == 'descuento':
            info_cliente[i] = float(info_cliente[i])
        cliente[campos_info[i]] = info_cliente[i]

    bbdd_clientes[info_cliente[0]] = cliente
